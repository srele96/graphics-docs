...
$$
$$
M_{r}\left(v_{a}\right)=\left[\cos\left(v_{a}\right),-\sin\left(v_{a}\right),\sin\left(v_{a}\right),\cos\left(v_{a}\right)\right]
$$
$$
...
$$
$$
O_{vecToPoint}\left(v_{a}\right)
$$
$$
O_{vecToPoint}\left(O_{multiply}\left(m_{s},v_{a}\right)\right)
$$
*Label: scaled*
...
$$
$$
O_{vecToPoint}\left(v_{ri}\right)
$$
*Label: inverse*
...
$$
$$
O_{vecToPoint}\left(v_{rti}\right)
$$
*Label: transpose & inverse*
